    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <h5>ID:</h5>
           <input type="text" id="ID"  onkeydown="return false" ><br>
            <br>
           
           <h5> SERIAL-NUMBER:</h5>
           <input type="text" id="SID" placeholder="eqwe"><br>
           <br>
           <h5>DISTRICT:</h5>
...
$(document).ready(function(){
  ...
  var para1 = new URLSearchParams(window.location.search);
    ...
    document.getElementById("ID").value =data6
    document.getElementById("SID").value =data2
    document.getElementById("OP").value =data4
    document.getElementById("DIS").value =data3
    document.getElementById("LONG").value =data7
    document.getElementById("LAT").value =data8
